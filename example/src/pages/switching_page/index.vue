    ...
    <div class="switch-card">
        <photo-switching :photos="list" @turnend="turnEndHandle($event)" @change="changeHandle($event)">
            <template slot-scope="slotProps">
                <div class="card-item" @click="toDet(slotProps.photo)">
                    <div class="img-banner" :style="{backgroundImage: `url(${slotProps.photo.pic})`}"></div>
                    <div class="title">{{slotProps.photo.title}}</div>
                    <div class="digest" v-if="slotProps.photo.digest">{{slotProps.photo.digest}}...</div>
                    <div class="time-from">
                        <span>{{slotProps.photo.ptime}}</span>
                        <span>{{slotProps.photo.source}}</span>
                    </div>
                </div>
            </template>
